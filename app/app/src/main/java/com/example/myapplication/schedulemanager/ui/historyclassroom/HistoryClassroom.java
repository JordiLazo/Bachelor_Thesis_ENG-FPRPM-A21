package com.example.myapplication.schedulemanager.ui.historyclassroom;
...
import com.example.myapplication.databinding.SmFragmentHistoryClassroomBinding;
...
public class HistoryClassroom extends Fragment {

    private SmFragmentHistoryClassroomBinding binding;
    private DatabaseReference dataBase;
    private PieChart pieChart;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        this.binding = SmFragmentHistoryClassroomBinding.inflate(inflater, container, false);
        View root = binding.getRoot();
        this.pieChart = root.findViewById(R.id.sm_piechart_history_classroom);
    ...
    private void loadPieChartData() {
        dataBase.child("classroom").child("A0101").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    private void setLegend(PieChart pieChart, int availableSeats, String percentatge) {
