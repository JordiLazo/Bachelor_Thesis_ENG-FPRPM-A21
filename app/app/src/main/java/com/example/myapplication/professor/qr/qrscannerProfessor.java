package com.example.myapplication.professor.qr;
...
public class qrscannerProfessor extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    public void handleResult(Result rawResult) {
        ...
        databaseReference.child("students").child(currentProfessor).child("courses").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                databaseReference.child("students").addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        databaseReference.child("students").child(currentProfessor).child("attendance").push().setValue(finalmap).addOnCompleteListener(new OnCompleteListener<Void>() {
                            @Override
