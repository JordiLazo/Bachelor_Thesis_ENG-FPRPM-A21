package com.example.myapplication.student.ui.historycourses;
...
public class HistoryCourses extends Fragment {
    ...
    private StudentFragmentHistoryCourseBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        this.binding = StudentFragmentHistoryCourseBinding.inflate(inflater, container, false);
